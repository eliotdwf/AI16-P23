...
VALUES
(1, 'Assistant(e) logistique', 'Cadre', 'Responsable logistique', 'Paris', 'Temps plein', 'À discuter', 'Nous recherchons un(e) assistant(e) logistique pour soutenir nos opérations logistiques à Paris. Le candidat idéal doit avoir une connaissance des procédures logistiques et être capable de travailler dans un environnement dynamique.', 2, '2024-09-30', 'CV, lettre de motivation', 2, curdate(), curdate(),'5678', 13, 1),
(2, 'Responsable marketing', 'Cadre', 'Directeur marketing', 'Lyon', 'Temps plein', 'À discuter', 'Nous recherchons un(e) responsable marketing passionné(e) pour développer et mettre en œuvre des stratégies de marketing innovantes. Le candidat idéal doit avoir une solide expérience en marketing et être capable de gérer une équipe.', 2, '2024-10-05', 'CV, lettre de motivation', 2, curdate(), curdate(), '5678', 4, 1),
